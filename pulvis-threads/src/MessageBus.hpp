...
namespace pulvis::threads
{
	...
	*/
	...
	constexpr uint32_t INVALID_CHANNEL_ID = UINT32_MAX;
	...
	/*
		...
		and are generated by RegisterChannel method.
	...
	*/
	...
	class CMessageBus
	{
		public:
			...
			uint32_t RegisterChannel(size_t _bufferSize = DEFAULT_RING_BUFFER_CAPACITY);
