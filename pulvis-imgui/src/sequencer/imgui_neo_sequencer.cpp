...
//
    ...
    bool NeoBeginTimeCursorTooltip(const char* id, NeoTooltipPositionFlags _flags, float tooltipWidth){
        ...
        if(ImGui::Begin(id, nullptr, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_Tooltip | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_AlwaysAutoResize)){
            return true;
        }
        // Restore
        ImGui::PopStyleVar(2);
