project "pulvis-ecs"
    ...
    files {
        PULVIS_ROOT .. "/pulvis-ecs/src/**.hpp",
        PULVIS_ROOT .. "/pulvis-ecs/src/**.cpp"
    }
    ...
    filter {}
    links { "pulvis-template-library", "pulvis-core", "pulvis-rtti", "pulvis-events", "pulvis-threads", "pulvis-filesystem", "pulvis-scriptable", "pulvis-rendering" }

    dependson { "pulvis-template-library", "pulvis-core", "pulvis-rtti", "pulvis-events", "pulvis-threads", "pulvis-filesystem", "pulvis-scriptable", "pulvis-rendering" }