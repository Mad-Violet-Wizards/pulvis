...
#error "`freetype/ft2build.h' hasn't been included yet!"
...
FT_BEGIN_HEADER
   ...
   *   file `freetype/ft2build.h`; the exact locations and names of the other FreeType
   *   header files are hidden by @header_file_macros, loaded by
   *   `freetype/ft2build.h`.  The API documentation always gives the header macro
